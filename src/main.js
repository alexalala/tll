...
$(window).scroll(function() {
    ...
    { 
        ...
        $.each(imagesTaken, function(index, value){
            var $image = value;
            var $imgStyle = $('<div class="col-md-12 galiria"><figure class="captionjs animated"><figcaption itemprop="name" style="margin-bottom:0px; bottom:-58px;">blah blah blag vmvfl mfvolmf</figcaption><img class="img1" src="' + $image + '"></figure></div>');
            images.push(value);
