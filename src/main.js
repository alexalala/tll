    ...
    $(window).scroll(function(alreadyLoading, imagesTaken) {
        if (($(window, ".gallery").scrollTop() + $(window).height() + offset >= $(document).height()) && alreadyLoading !== true) { 
            ...
            $(imagesTaken).each(function(index, value){
                ...
                var $imgStyle = $('<div class="col-xs-6 col-md-6 galiria"><figure class="captionjs animated"><figcaption itemprop="name" style="margin-bottom:0px; bottom:-58px;">' + $name + '</figcaption><img class="img1" src="' + $image + '" alt="' + $name + '" id="' + $simpleDesc + '"></figure></div>');
                images.push(value);
