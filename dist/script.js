...
var preloadedImages = [
    ...
    {url:'img/pics/blueCoatSchool.jpg', name:'The Blue Coat School', desc:'Shown in this picture is the Mystery Public Park blanketed in snow, looking ahead to the silhouette of the Blue Coat School and its clock tower.'},
...
var imagesLeft = [
    ...
    {url:'img/pics/holyTrinity.jpg', name:'The Holy Trinity Church', desc:'Built in 1794, the Holy Trinity Church is an active Anglican Parish Church in the deanery of Toxteth and Wavertree. More information on the church can be found on <a href="http://www.holytrinitywavertree.org.uk">this website</a>. This picture shows the church at Christmas time.'}, 
    {url:'img/pics/magnetCinema.jpg', name:'The Magnet Cinema', desc:'The Magnet Cinema was opened in 1914 on Picton Road and only had one screen, yet could seat up to 1038 people. The building has now lost its roof and has ironically been replaced with a roofing company.'}, 
    ...
    {url:'img/pics/railwaySidingsWavertree.jpg', name:'Railway Sidings, Wavertree', desc:'This painting is a night scene, illustrating railway workers loading the trains up with coal.. well before the days of health and safety! These are the Down Hill sidings on Edge Hill.'}, 
    {url:'img/pics/theLoversFirLane.jpg', name:'The Lovers, Fir Lane', desc:'A black and white painting, showing a lady and gentleman strolling through Fir Lane in the winter. In the background you can see the Blue Coat School, St. John\'s beacon (Radio City Tower) and both Liverpool Cathedrals.'}, 
    {url:'img/pics/theStreetSinger.jpg', name:'The Street Singer', desc:'A street singer that travelled around the district quite regularly, earning his living.'}, 
    {url:'img/pics/theWellington.jpg', name:'The Wellington', desc:'The Wellington Public House on Picton Road, with its vibrant red exterior. It is locally known as \'The Wellie\''}, 
    ...
    {url:'img/pics/victorianLetterbox.jpg', name:'Victorian Letterbox', desc:'This painting shows a little bit of history among today\'s 21st Century Life. The old Victorian Letterbox shown in this image has remained functional until relatively recently, when it was destroyed by vandals lighting a firework inside of it.'}, 
    ...
    {url:'img/pics/wellingtonAvenueWavertree.jpg', name:'Wellington Avenue, Wavertree', desc:'This painting portrays Wellington Avenue in Wavertree, which has now since been modernised.'}
];
